...
|---|-----------|----------|------|--------|-----------|
| — | [Azure 101](challenge-0-azure-101.md) *(Pre-work)* | 30 min | Self-paced | — | — |
| 1 | [Plan](challenge-1-plan.md) | 45 min | WDS | 25 | Plan |
| 2 | [Deploy Appliance](challenge-2-appliance.md) | 75 min | Hands-on | 25 | Prepare |
| 3 | [Assessment](challenge-3-assessment.md) | 45 min | Hands-on | 20 | Execute |
| 4 | [Execute](challenge-4-execute.md) | 30 min | WDS | 15 | Execute |
| 5 | [Curveball](challenge-5-curveball.md) | 30 min | WDS | 10 | Execute |
| 6 | [Optimize](challenge-6-optimize.md) | 45 min | WDS | — | Optimize |
| 7 | [Presentation](challenge-7-presentation.md) | 45 min | Present | 5 | All |
...
**Complete before the workshop**: [Pre-work: Azure 101](challenge-0-azure-101.md)
