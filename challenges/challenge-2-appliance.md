...
3. **Add Server Credentials** (for deeper discovery):
   ...
   > 💡 Get exact credentials from [ArcBox Environment](../participant/arcbox-environment.md)
...
After lunch, verify your discovered servers and proceed to [Challenge 3: Assessment](challenge-3-assessment.md).
