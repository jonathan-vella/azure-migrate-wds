...
| Azure Migrate Docs | [aka.ms/azuremigrate](https://aka.ms/azuremigrate) |
| CAF Migrate | [aka.ms/caf/migrate](https://learn.microsoft.com/azure/cloud-adoption-framework/migrate/) |
