...
|--------|---------|-------------|
| [Score-Team.ps1](../../../scripts/Score-Team.ps1) | Helper for scoring teams | During workshop |
| [Get-Leaderboard.ps1](../../../scripts/Get-Leaderboard.ps1) | Display team rankings | During workshop |
| [Cleanup-Resources.ps1](../../../scripts/Cleanup-Resources.ps1) | Delete all workshop resources | After workshop |
